...
h=aa.shape[0] #height
w=aa.shape[1] #width
#print(h,w) #test to check correct picture dimensions
...
iteration_sent = 1 #what packet number youv'e sent so far, sent as a header
...
for i in range (0, pixel_count):
	...
	if counter == size: #if you've reached the buffer size, send buffer to the RPi/Arduino
		#print('buffer size reached', iteration_sent)
